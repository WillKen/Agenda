...
void Metting::setParticipator(const std::vector<std::string> t_participators)
{
...
{
    std::vector<std::string>::iterator obj=find(m_participators.begin(),m_participators.end(),t_username);
